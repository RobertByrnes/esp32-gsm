...
const char SERVER[] = "example.server.com"; // Base url
...
// OAuth Token
const string OAUTH_HOST = "example.server.com";
...
const char *UPDATE_URL = "example.server.com/firmware.bin"; // must include either http:// or https:// for WiFi
