...
string OAuth2::extractToken(string JSON) // private
{
  ...
  int endOfToken = JSON.find_last_of("\"");
  string accesToken = JSON.substr(beginningOfToken, endOfToken);
 ...
 * @return std::string
 */
string OAuth2::personalAccessClientTokenRequestString() // public
{
 ...
 * @param clientId std::string
 * @param clientSecret std::string
 * 
 * @return bool
 */
bool OAuth2::setGrantType(const string grantType, uint clientId, const string clientSecret) // public
{
